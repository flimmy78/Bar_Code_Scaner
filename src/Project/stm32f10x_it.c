...
extern OS_EVENT *pKeypressedEvent;
extern vu32 bDeviceState; /* USB device status */
extern charge_detect_io_cnt;
...
void USART1_IRQHandler(void)
{
	...
	{
		recv_data = USART_ReceiveData(USART1) & 0xFF;              /* Read one byte from the receive data register         */

		Comm_IsrPutRxChar(COMM1, recv_data);
...
//#else
	...
	{   
		...
		Comm_IsrPutRxChar (COMM3, recv_data);	
